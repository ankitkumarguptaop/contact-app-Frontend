...
export const updateContactService = async (payload) => {
  ...
  return await axios.patch(`${process.env.REACT_APP_BACKEND_URL}contacts/${contact_id}`,updatedData);
};

export const createContactService = async (contactData) => {
  return await axios.post(`${process.env.REACT_APP_BACKEND_URL}contacts`,contactData);
};

export const recoverContactService = async () => {
  return await axios.put(`${process.env.REACT_APP_BACKEND_URL}contacts/recover`,);
};
